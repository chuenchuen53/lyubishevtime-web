import { LinkButton } from "@components/generate/LinkButton";
...
export default function Home() {
  return (
    <div class="flex flex-col items-center p-6">
      ...
      <p class="mb-6 text-lg font-normal text-gray-500 dark:text-gray-400 sm:px-16 lg:text-xl xl:px-48">時間管理</p>
      <div class="w-80">
        <img src={HomeImg} />
      </div>
